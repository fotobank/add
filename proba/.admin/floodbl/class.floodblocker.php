...
//
// Этот класс может быть использован для обнаружения и защиты веб-сайта от попыток залить его слишком много запросов. Она также позволяет для защиты сайта от автоматического скачивания большое количество страниц или файлов из одного IP-адреса. обнаружения наводнение, это определить, в соответствии с набором параметров с указанием максимально допустимое количество запросов за определенный промежуток времени. Можно установить несколько параметров одновременно для того, чтобы выполнять более эффективную защиту
//
// Requirements:
//   PHP >= 4.1.0
//
