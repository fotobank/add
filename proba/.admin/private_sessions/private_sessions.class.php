...
/*
 ...
 Этот класс может быть использован в качестве обработчика сессии для хранения данных сессии в частных каталогах или в таблице базы данных MySQL, а не по умолчанию временном каталоге системы. При использовании таблицы базы данных MySQL в качестве контейнера для данных сессии, класс заботится об открытии соединения с базой данных и выполнять SQL запросы по мере необходимости. Он также может создавать таблицы базы данных для хранения данных сеанса. При использовании частной каталога в качестве контейнера для данных сессии, класс заботится открытия, чтения и письма на сессию необходимые файлы.
*/
