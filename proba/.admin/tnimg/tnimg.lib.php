...
// -----------------------------------------------------------------------
//
// Этот класс может изменить размер изображения для создания миниатюр версий. Он может генерировать эскизы сохранении пропорции между шириной и высотой. Он также можете указать текстовые метки с заданным цвет, шрифт, размер, угол поворота и положение в изменения размеров изображения. Он может загружать изображения из файлов любого формата, поддерживаемого расширения GD и создавать эскизы в любом формате JPEG, PNG или GIF форматов . Изменения размеров изображения могут быть сохранены в конкретном файле или подается прямо в браузере пользователя.
//
// Requirements:
//   PHP >= 4.0.6, GD2
//
...
/*
  ...
  $ti->src_file = 'http://localhost/1.jpg';
