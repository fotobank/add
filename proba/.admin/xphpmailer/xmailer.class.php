...
// ----------------------------------------------------------------------------
//
// xmailer.class.php - Extended PHP Mailer class, ver.0.01 (May 17, 2005)
//
// Description:
//   PHP mail sending utility class allows to send attachments, process email
//   templates and convert messages from one Cyrillic charset to another
//   charset or to "translit".
//
// Author:
...
// Cyrillic character set constants
...
class XPhpMailer
{
  ...
  */
  function _encode ( $str, $cp_target, $xcode = FALSE )
  {
    ...
    {
      $str = strtr ( $str, 'абвгдезийклмнопрстуфхъыэ',
        'abvgdeziyklmnoprstufh\'ie' );
      $str = strtr ( $str, 'АБВГДЕЗИЙКЛМНОПРСТУФХЪЫЭ',
        'ABVGDEZIYKLMNOPRSTUFH\'IE' );
      $str = strtr ( $str, array ( 'ж'=>'zh', 'ц'=>'ts', 'ч'=>'ch',
        'ш'=>'sh', 'щ'=>'shch', 'ь'=>'', 'ю'=>'yu', 'я'=>'ya', 'Ж'=>'ZH',
...
$xmailer->to = 'Иванов Сергей';
$xmailer->subject = 'Здравствуйте!';
$xmailer->from_addr = 'petrov@myhost.com';
$xmailer->from_name = 'Петров А.';
$xmailer->attachments = array ( 'docs/project.zip', 'images/misc/me.jpg' );
$xmailer->msg = '<b>Текст сообщения...</b>';
