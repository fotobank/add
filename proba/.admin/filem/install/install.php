...
$z=new PclZip('install_data.d');
$z->extract();

echo('<html> <body> <b>PhpFileAdmin</b> - установка<br>');
?>Необходимые файлы были распакованы. Нажмите <a href="install2.php">Сюда</a> Для продолжения
</body>
</html>
<?php
