...
<head>
<meta name="description" content="<? echo $strLoginInterface . ' ' . $strPoweredBy . ' phpSecurePages'; ?>">
...
<!-- ------ Have you set up phpSP with no users?  ------ -->
        <? if ($useDatabase == false AND $useData == true AND $cfgLogin[1] == "") echo '<p style="font-family:arial;font-size:22px;color:red;font-weight:bold;">WEBMASTER: It looks like you have no users or passwords set up! <br>
...
<form id="entry" action="<? echo $_SERVER['REQUEST_URI'] ?>" METHOD="post" onSubmit="return checkData()">
...
<!-- ------ Copyright line starts here ------
        ...
        less (or un-) readable). -->
        <p><? echo $strPoweredBy; ?> <A HREF="http://www.phpSecurePages.com" TITLE="phpSecurePages <? echo $strInfo; ?>" TARGET="_blank" CLASS="link">phpSecurePages</A></p>
