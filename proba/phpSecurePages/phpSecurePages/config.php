<?php
/**************************************************************/
/*              phpSecurePages version 0.41 beta              */
...
/****** Choose Language ******/
$languageFile = 'lng_russian-cp1251.php';        // Choose from one of the 40 language files in the /lng directory
...
/* Ёти данные необходимы, если база данных не используетс€ */
$cfgLogin[1] = '1';                        // login word (username)
$cfgPassword[1] = '1';                     // password
$cfgUserLevel[1] = '1';                    // user level
  //¬ыберите число, которое представл€ет эту категорию уровень авторизации пользователей.
   // ќставьте пустым, если авторизаци€ уровней не используютс€.
  // See readme.txt for more info.
$cfgUserID[1] = '';                       // user identification
  // ввести индивидуальные идентификационные данные, если вы хотите быть в состо€нии определить текущего пользовател€
  // ќставьте пустым, если ни ID не требуетс€.
  // See readme.txt for more info.
