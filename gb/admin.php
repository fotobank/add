...
////////////// ПРАВКА СООБЩЕНИЙ //////////////
	...
	if ($QUERY_STRING == "login" || preg_match("/^page/",$QUERY_STRING)):
...
////////////// ИЗМЕНЕНИЕ НАСТРОЕК //////////////
	...
	if ($QUERY_STRING=="options"):
		...
		if(isset($_POST["change_opt"])):
			...
			if ($_POST["TABWIDTH_"]<400&&!preg_match("/\%/i",$_POST["TABWIDTH_"])) $TABWIDTH_ = 400; else $TABWIDTH_ = $_POST["TABWIDTH_="];
...
<table width=600 border=0 cellspacing=1 cellpadding=3 bgcolor=#CCCCCC><tr>
  <td align=center class=p1 bgcolor=#E8E8FF> &copy; 2013 </td>
</tr></table>
</td></tr>
</table>
</div>
