...
<? else: ?>
    ...
    <tr>
     <td> Пароль: </td> <td> <input class="inp_fent" type="password" name="password"></td>
      ...
      <tr></tr>
	 <tr>
	 <td><input data-placement="left" rel="tooltip" class="vhod" name="submit" type="submit" value="вход" title="Добро пожаловать!" data-original-title="Tooltip on left"></td> 
	  
	<td><a href="../registr.php" class="registracia" data-placement="right" data-original-title="Регистрация на сайт открыта!" >регистрация</a></td>	 
    </tr>	 	 	 	 
    </table>
