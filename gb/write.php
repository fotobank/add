<?php
	...
	~~
	IP-адрес: $ip
	Совпадение кодов антиспам-фильтра: $verification_code";
...
<table width=<?= $TABWIDTH ?> border=0
	...
	<tr bgcolor="<?= $LIGHT; ?>"
		...
		<td>
               <?php
                      if ($very_bad === 0) {
                             echo "<p class=p><strong>Сообщение добавлено.</strong></p>";
                      } elseif ($very_bad === 1) {
                             echo "<p class=p><strong>Сообщение НЕ добавлено. Несовпадение контрольных цифр:  '$verification_code'. </strong></p><br/>";
                      } elseif ($very_bad === 2) {
