						...
						<div class="pagination" align="center">
							...
							if ($current_page == 1)
							...
							else
								{
									...
									<a class="next" href="fotobanck.php?album_id=<?= intval($_SESSION['current_album']) ?>&amp;pg=<?= (
		...
		if ($may_view)
			{
				...
				$rs = mysql_query(
					'select SQL_CALC_FOUND_ROWS p.* from photos p where id_album = '.intval($_SESSION['current_album'])
