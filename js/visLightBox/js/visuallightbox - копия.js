(function (a)
{
   a.fn.visualLightbox = function (ah)
   {
      ...
      if ( ! document.getElementById(J("overlay")))
      {
         ...
         w.setAttribute("style", "margin-top: -20px;");
         w.cellSpacing = 0;
         aI.appendChild(w);
         ...
         var reiting = document.createElement("div");
         reiting.setAttribute("id", J("Reiting"));
         reiting.setAttribute("class", "div_reiting");
         aw.appendChild(reiting);

         var B = document.createElement("div");
         B.setAttribute("id", J("caption"));
         B.setAttribute("class", "ph_modern_nm");
         aG.appendChild(B);
         ...
         W.setAttribute("style", "height: 40px;");
         aG.appendChild(W);

         // таблица для элементов
         var tT = document.createElement("table");
         tT.setAttribute("id", J("tableData"));
         tT.setAttribute("border", "0");
         tT.setAttribute("cellspacing", "10px");
         tT.setAttribute("width", "100%");
         W.appendChild(tT);
         ...
         tDd.setAttribute("width", "10%");
         tDd.setAttribute("valign", "top");
         tR.appendChild(tDd);
         ...
         u.setAttribute("style", "width: 90px; padding-top: 0;");
         tDa.appendChild(u);

         var iBasket = document.createElement("input");
         iBasket.setAttribute("id", J("iBasket"));
         iBasket.setAttribute("type", "button");
         iBasket.setAttribute("value", "в корзину");
         iBasket.setAttribute("style", "cursor: pointer;");
         tDb.appendChild(iBasket);

         var iBasketP = document.createElement("p");
         iBasketP.setAttribute("id", J("iBasketP"));
         tDb.appendChild(iBasketP);

         var igoVote = document.createElement("input");
         igoVote.setAttribute("id", J("igoVote"));
         igoVote.setAttribute("type", "button");
         igoVote.setAttribute("value", "голосовать");
         igoVote.setAttribute("style", "cursor: pointer;");
         tDc.appendChild(igoVote);

         var igoVoteP = document.createElement("p");
         igoVoteP.setAttribute("id", J("igoVoteP"));
         tDc.appendChild(igoVoteP);


         // для инпута таблицы
         /* var dataSpan = document.createElement("span");
         dataSpan.setAttribute("id", "dataSpan");
         tDb.appendChild(dataSpan); */


         /*  var basketAdd = document.createElement("input");
         basketAdd.setAttribute("type", "button");
         basketAdd.setAttribute("id", "basketAdd");
         basketAdd.setAttribute("value", "в корзину");
         basketAdd.setAttribute("style", "cursor: pointer; float: left; position: relative; margin: 2px 0 0 10px;");
         basketAdd.setAttribute("class", "btn btn-small");
         basketAdd.setAttribute("onclick", "basketAdd(6574);");
         W.appendChild(basketAdd);

         var aGoVote = document.createElement("input");
         aGoVote.setAttribute("type", "button");
         aGoVote.setAttribute("id", "goVote");
         aGoVote.setAttribute("value", "голосовать");
         aGoVote.setAttribute("class", "btn btn-small");
         aGoVote.setAttribute("style", "cursor: pointer; margin: 2px 50px 0 0;  position: relative; float: none;");
         aGoVote.setAttribute("onclick", "goVote('0.00','0.01','6574');");
         W.appendChild(aGoVote); */

         // элементы навигации слева
         var aa = document.createElement("span");
         aa.setAttribute("id", J("detailsNav"));
         u.appendChild(aa);
         // числа текущее фото и всего
         var s = document.createElement("p");
         s.setAttribute("id", J("numberDisplay"));
         s.setAttribute("style", "margin-left: 20px; margin-top: -6px;");
         u.appendChild(s);
         ...
         else
         {
            ...
            D.setAttribute("style", "padding-top: 0px; float: right;");
      ...
      Q.css({color : "#555", font : "11px Arial,Verdana,sans-serif", padding : "3px 6px", width : "auto", height : "auto", margin : "0 0 0 0", outline : "none"});
      ...
      var q = this.start = function (c)
      {
         ...
         aX("overlay").css(
         {
            height : O()[1] + "px", top : 0, left : i().x + "px"
         }
         );
         if (ah.descSliding)
         {
         ...
         if (ah.startZoom)
         {
            ...
            aX("lightbox").css(
            {
               left : c.offset().left - ah.borderSize + "px", top : c.offset().top - ah.borderSize + "px", width : c.width() + ah.borderSize * 2 + "px", height : "auto"
            }
            )
         }
         else
      ...
      function g(c)
      {
         ...
         af.onload = function ()
         {
            ...
            // фотобанк стиль модерн
            function goParam(fotoId)
            {

               var  goBacketP = $(' #vlb1iBasketP ');
               var goVoteP = $(' #vlb1igoVoteP ');
               ...
               goBacketP.append('<div class="ajaxBusy"><p><img src="/img/loadM.gif"></p></div>');
               goVoteP.append('<div class="ajaxBusy"><p><img src="/img/loadM.gif"></p></div>');
               ...
               $.ajax(
               {
                  ...
                  success : function (html)
                  {
                     ...
                     goBacketP.empty().append((ans.price != 0) ? "цена фото: " + ans.price + " гр." : "цена фото: бесплатно");
               ...
               $.ajax(
               {
                  ...
                  success : function (data)
                  {
                     ...
                     else
                     {
                        dhtmlx.message(
                        {
                           text : ans.msg, expire : 10000, type : "addgolos"
                        }
                        );
            ...
            //             goVote('<?=$user_balans?>', '<?=$vote_price?>', '<?=$photo_data['id']?>')

            // click на элемент в корзину
            var clBacket = $(" #vlb1iBasket ");
            clBacket.unbind('click');
            clBacket.bind('click', function()
            {
               basketAdd(fotoId['1']);
            }
            );

            // click на элемент голосовать
            var clGoVoite = $(" #vlb1igoVote ");
            clGoVoite.unbind('click');
            clGoVoite.bind('click', function()
            {
               voteAdd(fotoId['1']);
            }
            );
            ...
            if ( ! be)
            {
               if (ah.startZoom)
               {
                  ...
                  if (d)
                  {
                     d.css(
                     {
                        width : (1 > bg ? "auto" : (d.width() / d.parent().width()) * 100 + "%"), height : (1 > bg ? (d.height() / d.parent().height()) * 100 + "%" : "auto"), left : 0, top : 0
                     }
                     )
                  }
                  a8.css(
                  {
                     opacity : 0, display : "block", position : "absolute", width : (1 > bg) ? ba + "%" : "auto", height : (1 > bg) ? "auto" : ba + "%", left : (100 - ba * (1 > bg ? 1 : bg)) / 2 + "%", top : (100 - ba * (1 > bg ? 1 / (bg) : 1)) / 2 + "%"
                  }
                  )
               }
               if (ah.startZoom)
      ...
      function L(a6, a1, a4, a5, a0, a7, a2)
      {
         ...
         if (ah.startZoom && ! a2)
         {
            ...
            , a7 < 1 ?
            {
               height : "120%", top : "-10%", left : (100 - 120 / a7) / 2 + "%"
            }
            :
            {
               width : "120%", left : "-10%", top : (100 - a7 * 120) / 2 + "%"
            }
            ),
            {
         ...
         a3.animate(
         {
            width : a4 + "px", height : a5 + "px"
         }
         ,
         {
            queue : false, duration : aQ * 1000, complete : ! a2 ? function ()
            {
               aU()
            }
            : null
      ...
      function G()
      {
         aX("overlay").css(
         {
            left : i().x + "px", top : 0, width : "100%", height : O()[1] + "px"
         }
         )
      }
