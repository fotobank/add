  ...
  if(mysql_num_rows($rs) > 0)
  {
     ...
     if($ftp_host && $ftp_user && $ftp_pass)
     {
	  ...
	  if ( $file_list === FALSE )
           {  
		      ftp_close($ftp);
              die ('Директория не существует! <br>');	          			  
           }
           
		    //var_dump($file_list);
			//echo 'Ответ ftp: <br><pre>', print_r($file_list,1), '</pre>';	 
		   
		    // Файл существует на самом деле? FTP дает недействительный ответ списка файлов	
	   if ( !count($file_list) )		
...
//   }
    	  ...
    	  ftp_close($ftp);		  
	      echo "<center><b>Загрузка файлов завершена!</b></center>";
  }
 }
}
...
<div>4.Перед изменением <b>папки в фотобанке</b> для закаченного альбома необходиммо сначала создать папку на сервере!</div>
</div>
</div>
<hr/>
...
<div class="input-append">					
      		      ...
      		      <td rowspan="3" align="center">
      		        <form action="index.php" method="post" style="margin: 0px;">
      		          ...
      		          <input class="btn-small btn-primary" type="submit" value="применить" style="margin-bottom: 10px;">
      		        </form>					
      		      </td>					
      		      <td rowspan="3">
				   <table border="0" >
...
<span class="add-on" style="padding-bottom: 0px; padding-top: 0px;">Цена за фото (гр.):</span>
<input id="prependedInput" class="span2" type="text" NAME="price" VALUE="<?=$ln['price']?>" style="margin-bottom: 0px; width: 152px;"/>
						  ...
						  <td style="padding-bottom: 3px;">Водяной знак</td>
      		            </tr>
						<tr>
<td><div class="input-prepend">
							 
							 
<span class="add-on" style="padding-bottom: 0px; padding-top: 0px;">Качество .jpg (%):</span>
<input id="prependedInput" class="span2" type="text" NAME="quality" VALUE="<?=$ln['quality']?>" style="margin-bottom: 0px; width: 154px;"/>
						     ...
						     <td style="padding-bottom: 3px;">IP надпись.</td>
						</tr>
      		            <tr>
<td><div class="input-prepend">
<span class="add-on">Категория:</span>																												
      		            ...
      		            <tr>
<td><div class="input-prepend">
<span class="add-on" style="padding-bottom: 0px; padding-top: 0px;">Пароль на альбом:</span>
<input id="prependedInput" class="span2" type="text" NAME="pass" VALUE="<?=$ln['pass']?>" style="margin-bottom: 0px; width: 152px;"/>													
</div></td> 
      		            </tr>
						<tr>
<td><div class="input-prepend">
<span class="add-on" style="padding-bottom: 0px; padding-top: 0px;">Папка фотобанка:</span>
<input id="prependedInput" class="span2" type="text" NAME="foto_folder" VALUE="<?=$ln['foto_folder']?>" style="margin-bottom: 0px;"/>
</div></td> 																																		
						</tr>
      		            <tr>
<td><div class="input-prepend">
<span class="add-on" style="padding-bottom: 0px; padding-top: 0px;">Папка uploada FTP:</span>
<input id="prependedInput" class="span2" type="text" NAME="ftp_folder" VALUE="<?=$ln['ftp_folder']?>" style="margin-bottom: 0px; width: 147px;"/>						  
		...
		<td style="padding-bottom: 3px;">Добавить резкость</td>  			 
                        </tr>						
      		            <tr>
				...
				<tr>
					...
					Папка альбома: "..<?=$ln['foto_folder']?><?=$ln['order_field']?>"
      		        <form action="index.php" method="post"  style="margin: 0px;">
