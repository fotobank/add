				...
				<div class="input-append">
					<form action="/canon68452/index.php?page=9" method="post">
						<label> <select class="span3" name="qzNameDb" style="height: 28px; float: left;">
								...
								?>
							</select> <input class="btn btn-info" type="submit" name="vosst" value="Restore"> </label>
					</form>
				</div>
			</div>
			<hr/>
				...
				<div class="input-append">
					<form action="/canon68452/index.php?page=9" method="post">
						<label> <select class="span3" name="qzNameDb" style="height: 28px; float: left;">
								...
								?>
							</select> <input class="btn btn-info" type="submit" name="deleteDB" value="Delete"> </label>
					</form>
				</div>
			</div>
			<hr/>
