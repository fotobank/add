...
<div class="input-append">
 ...
 while($ln = mysql_fetch_assoc($rs))
   ...
   <input class="btn btn-success" type="hidden" name="chenge_album" value="1"/>
 ...
 while($ln = mysql_fetch_assoc($rs))
  ...
  <div id="<?=$ln['id']?>"><img style="width: 120px; float: left;" alt="" src="<?=$foto_folder.$ln['id_album'].'/'.$ln['img']?>?t=<?=time()?>"></div>     
