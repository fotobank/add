...
/*
 Этот пакет может быть использована для передачи платежных требований Webmoney.ru или wmtransfer.com сайтов.
 Можно настроить веб-форму со всеми подробностями представить платежное требование.
Он может также проверять и обрабатывать ответы на оплату предварительные запросы, уведомления и результаты.
*/
