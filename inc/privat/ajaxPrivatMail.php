 ...
 */
  ...
  use Framework\Core\Mail\Sender;
       ...
       // период времени между отправками почты в секундах
       $wait_time = 3600;
       //  инициализация переменных и сброс времени и кол-ва отправки писем
  ...
  if(isset($_POST['prMail']))
	 {
	        if($session->get('invoice') < 3){
                 ...
                 $letter .= 'Кто-то (возможно, Вы) запросил реквизиты пополнения счета для сайта  http://'.
                        $_SERVER['HTTP_HOST']."\r\n";
                 ...
                 echo('Превышен лимит отправки писем (3шт.)');
          }
   }
