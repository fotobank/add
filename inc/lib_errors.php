	...
	public static function userErrorHandler($errno, $errmsg, $filename, $linenum, $vars)
		      {
			      ...
			      $error = array( " Дата:            " => $dt," Ip пользователя: " => Get_IP(), " Браузер:         " =>$_SERVER['HTTP_USER_AGENT'],
			                      " Номер ошибки:    " => $errno , " Тип ошибки:      " => $errortype[$errno], " Сообщение:       " => $errmsg,
			                      " Файл скрипта:    " =>$filename, " Номер линии:     " => $linenum );
