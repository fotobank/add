<?php
/*
Plugin Name: WP Comment Quicktags Plus
Plugin URI: http://aboutme.lmbbox.com/
Description: Кнопки форматирования в комментариях и ссылка на "Цитировать". Расширенная версия плагина от <a href="http://www.wordpressplugins.ru">WordpressPlugins.ru</a>.
Version: 1.4
...
version 1.4 расширенная, 21.07.2008

Modified By Thomas Montague
...
WP Comment Quicktags Plug is a plugin that puts a Quicktag Menu bar, just like the admin's 
...
1. Copy the file wp-comment-quicktags-plus.php into your wp-content/plugins directory
...
#### Styling the Toolbar ####
4. The code added at the wp_comments_quicktags_plus() function call has some CSS styling tags 
	...
	(eg. My plugin -> WP Smileys Plugin). All of the buttons are inputs with 
...
Хак для исправления отображения кнопок через Internet Explorer.
.ed_button { 
	width: 0;  
	overflow: visible;
	}
...
5. If you wish to change/edit the Quicktag Buttons that are displayed, you will need to edit 
	...
	added and what to save if you upgrade to a new version of WP Comment Quicktags Plus.
...
if(defined('ABSPATH')) {
	function wp_comment_quicktags_plus() {
		// BOF -- wp_comment_quicktags() -> loads quicktags into comment forum area
		...
		<?php endif;
		// EOF -- wp_comment_quicktags() -> loads quicktags into comment forum area
	}

	function wp_comment_quicktags_plus_define_textfield() {	
		echo '
