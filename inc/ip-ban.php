    ...
    function check($ip, $ipLog, $timeout) // проверка бана
        {
            ...
            if (!isset($_SESSION['popitka'][$_SESSION['current_album']]) || $_SESSION['popitka'][$_SESSION['current_album']] < 0 || $_SESSION['popitka'][$_SESSION['current_album']] > 5 && $_SESSION['popitka'][$_SESSION['current_album']] != -10
            )
                {
                    ...
                    foreach ($data as $key => $record)
                        {
                            ...
                            elseif ($ip == $subdata[0] && $now > ($subdata[1] + 60 * $timeout) && $_SESSION['current_album'] == $subdata[2] && $_SESSION['popitka'][$_SESSION['current_album']] <= 0 && $_SESSION['popitka'][$_SESSION['current_album']] > 5
            ...
            elseif (!$data && $_SESSION['popitka'][$_SESSION['current_album']] <= 0 && $_SESSION['popitka'][$_SESSION['current_album']] > 5
            )
                {
                    $_SESSION['popitka'][$_SESSION['current_album']] = 5;
                }
