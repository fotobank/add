...
// -------------------------------------
// Êîíôèãóðàöèÿ êðèïòîãðàììû
// -------------------------------------

$cryptwidth  = 120;  // Largeur du cryptogramme (en pixels)
$cryptheight = 40;   // Hauteur du cryptogramme (en pixels)

$bgR  = 255;         // Öâåò ôîíà â ôîðìàòå RGB: Red (0->255)
$bgG  = 255;         // Öâåò ôîíà â ôîðìàòå RGB: Green (0->255)
$bgB  = 255;         // Öâåò ôîíà â ôîðìàòå RGB: Blue (0->255)

$bgclear = true;     // ïðîçðà÷íûé ôîí (true/false)
                     // Äåéñòâèòåëüíî òîëüêî äëÿ PNG

$bgimg = '';                 // Â êðèïòîãðàììå ôîí ìîæåò áûòü
                             // PNG, GIF èëè JPG. Ïîêàçàòü ôàéë èçîáðàæåíèÿ
                             // Ïðèìåð: $fondimage = 'photo.gif';
				                 // Èçîáðàæåíèå áóäåò èçìåíÿòü ðàçìåð
                             // ÷òîáû óìåñòèòüñÿ â êðèïòîãðàììó.
                             // åñëè çàäàííî íåñêîëüêî ôîíîâ -
                             // ôîí áóäåò âçÿò íàóãàò
                             // èç äîñòóïíûõ çàäàííûõ répertoire

$bgframe = false;    // Äîáàâëÿåò ðàìêó (true/false)
