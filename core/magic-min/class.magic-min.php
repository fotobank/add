<?php
  ...
  require (__DIR__.'./../dump/dump_r.php');
  require_once (__DIR__.'/../../inc/config.php');
  require_once (__DIR__.'/../../inc/func.php');
  require_once (__DIR__.'./../checkSession/checkSession.php');
        ...
        if( !empty( $order ) )
        {
            ...
            foreach( $order as $key => $this->specified['file'] )
            {
              ...
              //Check each file for modification greater than the output file if it exists
                ...
                {
                    $this->messages[]['Minifier Log: New File Flagged'] = 'Flagged for update by '. $this->specified['file'];
