...
class debugger_SHOWCONTEXT
{
				...
				private function _makeLinc($var) {
								return "<span class='contextTitre'
								onclick='document.getElementById('#var{$var}').style.display=(document.getElementById('#var{$var}').style.display == 'block')?'none':'block';'>
								{$var}</span>";
				}
     ...
     * @return string
     */
    private function varExport($var, $maxLevel = 10, $level = 0)
    {
        $escapes = "\"\r\t\x00\$";
        $tab = '    ';
