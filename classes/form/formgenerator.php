 ...
 */
    ...
    //config options        
        ...
        $this->config["validator"]["value"]="classes/form/validators.php";
        $this->config["validatorClass"]["value"]="form_Validator";
            ...
            if ($this->validator===NULL) {
                ...
                if(($this->getConfig("validator"))&&(file_exists($this->getConfig("validator")))) {
                    ...
                    if (class_exists($this->getConfig("validatorClass"))) {
                        ...
                        throw new Exception("Validator class &quot;" .$this->getConfig("validatorClass"). "&quot; не найден.");
                    }
                }else {
                    throw new Exception("Файл не найден: &quot;".$this->getConfig("validatorClass"). "&quot;");
                }
            }
