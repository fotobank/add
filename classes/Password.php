...
class Password
{
	...
	/**
	 * Проверять качества (сложность) пароль
	 *
	 * Bad passwords
	...
	/**
	 * Генерация высококачественного и устойчивостью к растрескиванию пароль
	 *
	...
	/**
   * Метод, который возвращает производных от пароля, чтобы иметь возможность войти в систему (авторизация),
   * независимо от раскладки клавиатуры (языка ввода) и нажатыми [Caps Lock] или [Shift] кнопками.
